...
you should place your code here."
  ...
  ;;
  ;; emacsclient launches in the *scratch* buffer
  ;;
  ...
  ;; Hack to fix https://github.com/syl20bnr/spacemacs/issues/9549
  (require 'helm-bookmark)

  ;; titlecase function from http://ergoemacs.org/emacs/elisp_title_case_text.html
